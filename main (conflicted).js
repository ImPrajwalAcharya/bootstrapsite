    ...
    for (let i = 0; i < currentWork.length; i++) {
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card h-100">
            <img src="${photoURL}" class="card-img-top rounded img-fluid img-thumbnail" alt="...">
            ...
            <button  type="button" onclick="window.location.href="#home"" class="main-btn">View on GitHub</button>
            </div>
          </div>
        </div>
      `;
